            ...
            >
              ...
              <div className="bg-card border border-border rounded-2xl p-6 mb-6">
                ...
                <p className="text-muted-foreground">
                  To be a leading healthcare institution known for clinical excellence, compassion, and integrity in patient care.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/80 max-w-2xl mx-auto mb-8">
              Join thousands of families who trust Cedarcare Hospital for their healthcare needs.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary rounded-full font-semibold hover:shadow-xl transition-shadow"
            >
              Book an Appointment
